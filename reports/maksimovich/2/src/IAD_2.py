...
y = optical_recognition_of_handwritten_digits.data.targets.values.ravel()
...
# 2D автоэнкодер
scatter_2d = axes[0, 0].scatter(X_encoded_2d[:, 0], X_encoded_2d[:, 1], c=y, cmap='tab10', alpha=0.7)
...
for i, perplexity in enumerate(perplexities):
    ...
    # Визуализация 2D
    scatter_2d = axes[0, i].scatter(X_tsne_2d[:, 0], X_tsne_2d[:, 1], c=y, cmap='tab10', alpha=0.7)
...
# PCA 2D
scatter_pca_2d = axes[0].scatter(X_pca_2d[:, 0], X_pca_2d[:, 1], c=y, cmap='tab10', alpha=0.7)
...
scatter1 = ax1.scatter(X_encoded_2d[:, 0], X_encoded_2d[:, 1], c=y, cmap='tab10', alpha=0.7)
...
scatter3 = ax3.scatter(X_tsne_best[:, 0], X_tsne_best[:, 1], c=y, cmap='tab10', alpha=0.7)
...
scatter5 = ax5.scatter(X_pca_2d[:, 0], X_pca_2d[:, 1], c=y, cmap='tab10', alpha=0.7)
...
print("\n1. АВТОЭНКОДЕР:")
print(f"   - Архитектура: 64 → 128 → 64 → 32 → 2/3 → 32 → 64 → 128 → 64")
